...
// Recruiter Page
Route::get('/recruitment', [RecruiterController::class, 'recruitment'])->name('recruitment');
...
// Applicant Page
Route::get('applicant/applicant-registration', [ApplicantController::class, 'index']);
